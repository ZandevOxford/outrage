...
- `type` (string or null; default null) — Backend to open `file` with, when the file name does not say: 'files' for a directory of files, 'duckdb' for a directory of parquet parts, 'parquet' to read one parquet file with pyarrow rather than duckdb

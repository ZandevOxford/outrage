...
### outrage.store.backend_for(filename: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [PathLike](https://docs.python.org/3/library/os.html#os.PathLike)[[str](https://docs.python.org/3/builtins/stdtypes.html#str)] | [None](https://docs.python.org/3/builtins/constants.html#None) = None, backend: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None) → [type](mounts.md#outrage.mounts.Spec.type)[[FileStore](#outrage.store.FileStore)]

The backend class a store file, or a `type=`, names.

`_backend_for()` under a public name, for the one thing a front end
...
not a way to construct one: [`default_store()`](#outrage.store.default_store) is, and it is what
...
#### manages_schema *: [ClassVar](https://docs.python.org/3/library/typing.html#typing.ClassVar)[[bool](https://docs.python.org/3/builtins/functions.html#bool)]* *= False*
...
place at open is safe and is what [`format_version`](#outrage.store.FileStore.format_version) means there.
...
#### *property* target *: [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), [str](https://docs.python.org/3/builtins/stdtypes.html#str)] | [None](https://docs.python.org/3/builtins/constants.html#None)*

Where the store is, for a backend whose store is not `path`.

None for every store kept in a file, which `path` already names.
...
[`FilesystemStore`](store_files.md#outrage.store_files.FilesystemStore) overrides this and takes
...
[`outrage.mounts.refuse_missing_read_only()`](mounts.md#outrage.mounts.refuse_missing_read_only), so that the refusal
...
[`manages_schema`](#outrage.store.FileStore.manages_schema) -- so the base refuses rather than offering an
open that would be indistinguishable from the ordinary one. A front
end asks [`manages_schema`](#outrage.store.FileStore.manages_schema) first and says so in its own words;
...
### *class* outrage.store.SchemaState(backend: [str](https://docs.python.org/3/builtins/stdtypes.html#str), service: [str](https://docs.python.org/3/builtins/stdtypes.html#str), path: [Path](https://docs.python.org/3/library/pathlib.html#pathlib.Path), schema: [str](https://docs.python.org/3/builtins/stdtypes.html#str), stored: [SchemaVersion](#outrage.store.SchemaVersion) | [None](https://docs.python.org/3/builtins/constants.html#None), oldest: [int](https://docs.python.org/3/builtins/functions.html#int), newest: [int](https://docs.python.org/3/builtins/functions.html#int), operating: [int](https://docs.python.org/3/builtins/functions.html#int) | [None](https://docs.python.org/3/builtins/constants.html#None), writable: [bool](https://docs.python.org/3/builtins/functions.html#bool), problem: [Refusal](errors.md#outrage.errors.Refusal) | [None](https://docs.python.org/3/builtins/constants.html#None) = None)
...
schema is answered in, like [`Report`](maintenance.md#outrage.maintenance.Report) for a
...
#### service *: [str](https://docs.python.org/3/builtins/stdtypes.html#str)*
...
#### schema *: [str](https://docs.python.org/3/builtins/stdtypes.html#str)*

The schema inside the database the store is, or would be, in.

#### stored *: [SchemaVersion](#outrage.store.SchemaVersion) | [None](https://docs.python.org/3/builtins/constants.html#None)*

The store's own three numbers, or None where there is no store.

#### oldest *: [int](https://docs.python.org/3/builtins/functions.html#int)*

The oldest version this build operates at.

#### newest *: [int](https://docs.python.org/3/builtins/functions.html#int)*

The newest version this build knows, and what it would create at.

#### operating *: [int](https://docs.python.org/3/builtins/functions.html#int) | [None](https://docs.python.org/3/builtins/constants.html#None)*
...
### *class* outrage.store.SchemaVersion(version: [int](https://docs.python.org/3/builtins/functions.html#int), read_floor: [int](https://docs.python.org/3/builtins/functions.html#int), write_floor: [int](https://docs.python.org/3/builtins/functions.html#int))
...
#### read_floor *: [int](https://docs.python.org/3/builtins/functions.html#int)*

#### write_floor *: [int](https://docs.python.org/3/builtins/functions.html#int)*
...
[`FileStore.in_directory()`](#outrage.store.FileStore.in_directory).
...
### outrage.store.locates_own_store(backend: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, \*, unknown: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None) → [bool](https://docs.python.org/3/builtins/functions.html#bool)
...
recognise, and the default refuses it in `_backend_for()`'s words. A

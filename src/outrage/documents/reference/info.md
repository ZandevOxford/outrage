...
### *class* outrage.info.Info(version: [str](https://docs.python.org/3/builtins/stdtypes.html#str), python: [str](https://docs.python.org/3/builtins/stdtypes.html#str), prefix: [str](https://docs.python.org/3/builtins/stdtypes.html#str), command: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), ...] = (), directory: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, mount_config: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), ...] = (), log: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, log_content: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None, mounts: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[MountInfo](#outrage.info.MountInfo), ...] = ())
...
#### python *: [str](https://docs.python.org/3/builtins/stdtypes.html#str)*
...
#### command *: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), ...]*
...
#### directory *: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None)*
...
#### mount_config *: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), ...]*

The mount configuration files read, in the order they were read.

#### log *: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None)*

Where this process is recording what it does, or None when it is not.

#### log_content *: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None)*

How much document text that log keeps, or None when there is no log.

#### mounts *: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[MountInfo](#outrage.info.MountInfo), ...]*
...
#### mount *: [str](https://docs.python.org/3/builtins/stdtypes.html#str)*

The mount point written for a person to read; the root is `/`.

#### path *: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None)*
...
#### target *: [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), [str](https://docs.python.org/3/builtins/stdtypes.html#str)] | [None](https://docs.python.org/3/builtins/constants.html#None)*
...
### outrage.info.mount_infos(opened: [Store](store.md#outrage.store.Store)) → [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[MountInfo](#outrage.info.MountInfo), ...]

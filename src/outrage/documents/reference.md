...
[`outrage.errors`](reference/errors.md#module-outrage.errors) and [`outrage.notes`](reference/notes.md#module-outrage.notes) are the two carriers, and each
holds a code and its facts rather than words. [`outrage.messages`](reference/messages.md#module-outrage.messages) is where
...
* [outrage.notes](reference/notes.md)

...
may restore the latter read-only for the current server. A home store that
cannot be opened stops startup rather than allowing `home/...` writes to fall
through into the project root.
